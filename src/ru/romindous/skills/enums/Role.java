...
public enum Role {
    ...
    VAMPIRE("Вампир", "§4", ItemType.BEETROOT_SOUP, Stat.METABOLISM,
    ...
    ASSASIN("Ассасин", "§d", ItemType.AMETHYST_SHARD, Stat.AGILITY,
    ...
    ARCHER("Стрелок", "§c", ItemType.CROSSBOW, Stat.ACCURACY,
    ...
    WARRIOR("Паладин", "§e", ItemType.IRON_SWORD, Stat.STRENGTH,
    ...
    MAGE("Маг", "§9", ItemType.HEART_OF_THE_SEA, Stat.MAGIC,
    ...
    PHANTOM("Фантом", "§5", ItemType.PHANTOM_MEMBRANE, Stat.SPIRIT,
    ...
    NECROS("Некромант", "§о", ItemType.KNOWLEDGE_BOOK, Stat.CONTROL,
    ...
    STONER("Каменьщик", "§ч", ItemType.CHAINMAIL_CHESTPLATE, Stat.PASSIVE,
    ...
    Role(final String name, final String color, final ItemType icon, final Stat stat, final String... desc) {
        this.name = name;
        this.color = color;
        this.icon = icon;
        this.stat = stat;
