...
public class Bleeding {
    ...
    public boolean endTick() {
        ...
        tgt.damage(dmg, dmgr == null || !dmgr.isValid() ? DamageSource.builder(DamageType.INDIRECT_MAGIC).withDamageLocation(tgt.getLocation()).build()
            : DamageSource.builder(DamageType.INDIRECT_MAGIC).withDirectEntity(dmgr).withCausingEntity(dmgr).withDamageLocation(tgt.getLocation()).build());
